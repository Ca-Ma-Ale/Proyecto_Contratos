...
urlpatterns = [
    ...
    path('exportaciones/otrosi/', views.exportar_otrosi, name='exportar_otrosi'),
    path('exportaciones/polizas/', views.exportar_polizas, name='exportar_polizas'),
    path('exportaciones/seguimientos/', views.exportar_seguimientos, name='exportar_seguimientos'),
    path('exportaciones/vencimientos/', views.exportar_vencimientos, name='exportar_vencimientos'),
    path('exportaciones/historial-ajustes/', views.exportar_historial_ajustes, name='exportar_historial_ajustes'),
    path('exportaciones/locales-ocupacion/', views.exportar_locales_ocupacion, name='exportar_locales_ocupacion'),
    ...
    path('contratos/<int:contrato_id>/finalizar/', views.finalizar_contrato, name='finalizar_contrato'),
    ...
    path('informes-ventas/calculo/<int:calculo_id>/confirmar-finalizar/', views.confirmar_y_finalizar_calculo, name='confirmar_y_finalizar_calculo'),
    path('informes-ventas/calculo/<int:calculo_id>/eliminar/', views.eliminar_calculo_facturacion, name='eliminar_calculo_facturacion'),
    ...
    # path('salario-minimo/calculo/<int:calculo_id>/editar/', views.editar_calculo_salario_minimo, name='editar_calculo_salario_minimo'),  # Deshabilitado - no se permite editar cálculos
